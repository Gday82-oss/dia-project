...
import { agents, strates, dialecticalAxes, getAgentTheme } from "../agent.data";
...
export default function AgentPage() {
  ...
  const agent = agents.find(
    a => a.code.toLowerCase() === agentCode?.toLowerCase()
  );
    ...
    return (
      ...
      >
        <div className="text-center">
          <h1
            className="text-4xl font-bold mb-4 tech-text"
            style={{ color: "#00d4ff" }}
          >
            Agent non trouvé
          </h1>
  ...
  const axis = dialecticalAxes.find(
    ax => ax.agentA === agent.code || ax.agentB === agent.code
  );
  const partnerCode = axis
    ? axis.agentA === agent.code
      ? axis.agentB
      : axis.agentA
    : null;
      ...
      <div className="relative z-10 container py-8 md:py-12 max-w-5xl">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-8 relative z-10">
            <div className="flex-1">
              ...
              <motion.div className="flex items-center gap-4 mb-6" {...fadeIn}>
                <h2
                  className="text-4xl md:text-5xl greek-text"
                ...
                <span
                  ...
                  style={{ color: theme.palette.text + "60" }}
                >
                  ({agent.greekKey})
                </span>
              </motion.div>
              ...
              <motion.div {...fadeIn}>
                ...
                <p
                  ...
                  style={{ color: theme.palette.text + "dd" }}
                >
                  {agent.title}
                </p>
              </motion.div>
          ...
          >
            ...
            <span
              className="text-sm"
              style={{ color: theme.palette.text + "80" }}
            >
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <div className="pl-4">
              <h3
                className="text-[10px] tech-text mb-4 uppercase tracking-[0.2em]"
                style={{ color: theme.palette.accent + "80" }}
              >
                Projection Mentale
              </h3>
              <blockquote
                ...
                style={{ color: theme.palette.text + "ee" }}
              >
                "{agent.projection}"
              </blockquote>
              <p
                className="text-xs"
                style={{ color: theme.palette.text + "50" }}
              >
                La voix intérieure de {agent.name} — comment cet agent se
                perçoit dans le réseau.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="pl-4">
              ...
              <p
                ...
                style={{ color: theme.palette.text + "50" }}
              >
                Fonction de {agent.name} au sein de la strate{" "}
                {strateInfo.numeral}.
              </p>
            </div>
          </motion.div>
        ...
        <motion.div className="p-6 md:p-8 mb-8" style={cardStyle()} {...fadeIn}>
          <h3
            className="text-[10px] tech-text mb-6 uppercase tracking-[0.2em]"
            style={{ color: theme.palette.accent + "80" }}
          >
            Flux de Transformation
          </h3>
              ...
              <div key={step.label} className="contents">
                {i > 0 && (
                  <div
                    ...
                    style={{ color: theme.palette.accent + "60" }}
                  >
                    →
                  </div>
                )}
                <div className="flex-1 min-w-[100px] text-center">
                  ...
                  <div
                    className="text-[10px] tech-text mb-1 tracking-wider"
                    style={{ color: theme.palette.text + "60" }}
                  >
                    {step.label}
                  </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span
                    className="font-semibold tech-text text-sm"
                    style={{ color: theme.palette.accent }}
                  >
                    {agent.name}
                  </span>
                  <span
                    className="text-xs greek-text block"
                    style={{ color: theme.palette.text + "60" }}
                  >
                    {agent.greek}
                  </span>
              ...
              <span
                className="text-xl"
                style={{ color: theme.palette.text + "40" }}
              >
                ↔
              </span>
              <Link
              ...
              >
                <div className="text-right">
                  <span
                    className="font-semibold tech-text text-sm"
                    style={{ color: partnerTheme.palette.accent }}
                  >
                    {partner.name}
                  </span>
                  <span
                    className="text-xs greek-text block"
                    style={{ color: partnerTheme.palette.text + "60" }}
                  >
                    {partner.greek}
                  </span>
                </div>
                <div
                  className="w-4 h-4 rounded-full"
                  style={{ background: partnerTheme.palette.accent }}
                />
              </Link>
            </div>
          </motion.div>
        ...
        <motion.div className="p-6 md:p-8 mb-8" style={cardStyle()} {...fadeIn}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <p
                className="text-[10px] tech-text mb-2 tracking-wider"
                style={{ color: theme.palette.text + "60" }}
              >
                PALETTE
              </p>
            ...
            <div>
              ...
              <p
                className="text-xs"
                style={{ color: theme.palette.text + "aa" }}
              >
                {theme.shapes.motif}
              </p>
            </div>
