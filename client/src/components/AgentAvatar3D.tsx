...
const agentRotationConfig: Record<
  string,
  { duration: number; direction: "normal" | "reverse"; tilt: number }
> = {
...
export default function AgentAvatar3D({
  ...
  const config = agentRotationConfig[agentCode] || {
    duration: 10,
    direction: "normal",
    tilt: 5,
  };
